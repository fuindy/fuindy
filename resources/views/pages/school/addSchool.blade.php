...
<link href="{{asset(mix('plugins/css/switchery.min.css'))}}" rel="stylesheet" type="text/css" media="screen"/>
...
<!-- push needed plugins for this page -->
<script src="{{asset(mix('plugins/js/autoNumeric.js'))}}" type="text/javascript"></script>
<script src="{{asset(mix('plugins/js/jquery.bootstrap.wizard.min.js'))}}" type="text/javascript"></script>
<script src="{{asset(mix('plugins/js/jquery.validate.min.js'))}}" type="text/javascript"></script>
@endpush
...
@section('content')
    ...
    <div class="content">
        ...
        <div class="jumbotron" data-pages="parallax">
            <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
                <div class="inner">
                    <!-- START BREADCRUMB -->
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('school.view.add') }}">School</a></li>
        ...
        <div class="container-fluid container-fixed-lg">
            ...
            <div id="form-add-school" class="hide">
                <!-- Nav tabs -->
                <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm no-click" role="tablist"
                    data-init-reponsive-tabs="dropdownfx">
                    <li class="nav-item">
                        <a class="active"
                           id="information-school"
                           data-toggle="tab" href="#" role="tab"><i class="fa fa-user tab-icon"></i> <span>Information School</span></a>
                    </li>
                    <li class="nav-item">
                        <a class=""
                           id="choose-department"
                           data-toggle="tab" href="#" role="tab"><i class="fa fa-user-md tab-icon"></i> <span>Choose Department</span></a>
                    </li>
                    <li class="nav-item">
                        <a class=""
                           id="photo-school"
                           data-toggle="tab" href="#" role="tab"><i class="fa fa-file-text tab-icon"></i> <span>Photo School</span></a>
                    </li>
                    <li class="nav-item">
                        <a class=""
                           id="photo-gallery"
                           data-toggle="tab" href="#" role="tab"><i class="fa fa-file-text tab-icon"></i> <span>Gallery</span></a>
                    </li>
                </ul>
            ...
            <div id="form-add-school" class="">
                <!-- Tab panes -->
                <div class="row">
                    <div class="col-md-12 m-b-10" v-if="!showCreateForm">
                        <button class="btn btn-primary pull-right">
                        Insert Device
                        </button>
                    </div>
                    <div class="col-md-8 m-b-10"></div>
                    <div class="col-md-4 m-b-10" v-if="showCreateForm">
                        ...
                        <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle align-self-stretch d-flex flex-column">
                            <div class="card-block">
                                <form id="fingerspot-form">
                                    <i class="fa fa-times text-danger pull-right cursor fs-16"></i>
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox check-success ">
                                                    <input type="checkbox"
                                                           ...
                                                           name="isActivated"
                                                           id="isActivated">
                                                    <label for="isActivated">Activate</label>
                                                </div>
                                            </div>
                                        </div>
