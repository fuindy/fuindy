...
class GallerySchoolLogic extends GallerySchoolUseCae
{
            ...
            if ($request->hasFile('fileImage') && $request->file('fileImage')->isValid()) {
                ...
                if ($gallery) {
                    ...
                    foreach ($galleryFiles as $galleryFile) {
                        ...
                        $saveFile = GallerySchoolFile::create([
    ...
    public function handleListImage()
    {
        ...
        if ($schoolId != null) {
            ...
            $galleries = GallerySchool::where('school_id', $schoolId)
    ...
    {
        $schoolId = !is_null(Auth::user()->customer->school_id) ? Auth::user()->customer->school_id : null;
