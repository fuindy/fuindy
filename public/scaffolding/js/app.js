...
__webpack_require__("./resources/assets/js/echo-server/main.js");
...
/***/ "./resources/assets/js/echo-server/main.js":
...
window.echo = __WEBPACK_IMPORTED_MODULE_0_laravel_echo___default()({
...
$(document).ready(function () {
    ...
    if (!isChrome()) {
        $('.page-container').pgNotification({
            style: 'flip-right',
            message: 'GXApp currently only supports <b>Chrome</b> browser, ' + '<b>it is recommended to use Chrome</b> for better performances and to avoid existing bugs on other browser. ' + 'We are still working on to make it compatible with other browser too.',
            position: 'top-right',
            timeout: 20000,
            type: 'warning'
        }).show();
    ...
    $('#custom-btn-page').click(function () {
        ...
        $(document).ready(function () {
            $('.custom-page-sidebar').hover(function () {
